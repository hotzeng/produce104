...
typedef struct pcb {
    ...
    uint32_t *usp;
    int nested_count;
    /* entry.S depends on the precise ordering of fields preceding this
       comment */
    uint32_t entry_point;
    pid_t pid;
    task_type_t task_type;
    ...
    /* If this process is in the sleep
     * queue, this tells us the time
     * after which we should let it out.
     */
    uint64_t sleep_until;

    /* For priorities, keep track
